...
ot_b=ot_is+'af1.opentracker.net';
...
if(ot_c.cookie.indexOf('machine-id')!=-1)ot_ac=true;else{
 if(ot_c.cookie.indexOf('machine-id')==-1) f_sc("machine-id","194.171.10.62:1369908187050",ot_cd,"/");
 if(ot_c.cookie.indexOf('machine-id')!=-1)ot_ac=true;
}
ot_rc=f_rc("machine-id");ot_lc=escape((typeof ot_url===ot_un)?ot_d.location:ot_url);ot_t0=1369908187050;
...
function f_log(send) {
 ...
 ot_im.src=ot_b+'/collect.jsp?p=1&mid='+ot_rc
  +'&fv='+ot_fv+'&ti='+ot_ti+'&si=www.screechmedia.com'
  +ot_goal+ot_clv
...
function ot_f(e) {
 ...
 ot_im=new Image(1,1);
 ot_im.src=ot_b+'/collect_.jsp?p=3&mid='+ot_rc+'&si=www.screechmedia.com&ms='+ot_l+'&lc='+ot_lc+'&ti='+ot_ti+'&t0='+ot_t0;
...
ot_im=new Image(1,1);
ot_im.src=ot_b+'/collect_.jsp?p=2&mid='+ot_rc+'&si=www.screechmedia.com&ms='+m+'&lc='+ot_lc+'&ti='+ot_ti+'&t0='+ot_t0;
